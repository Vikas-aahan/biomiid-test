export default {
	...
	section5_content1_1: "Service Providers- In order to accomplish the goals outlined in this statement, we divulge Private Data to vendors or agents acting on our behalf. For instance, businesses we've contracted with to support customer service or help safeguard and secure our services and systems may require access to Private Data to perform those duties.",
	section5_content1_2: "Disclosing information to Public- You can choose to share and publicly display your name, username, profile, demographic information, content and files, and geolocation data using the options made accessible through our services.",
	section5_content1_3: "Financial Services- We will share transactional data with banking institutions and other organizations as required for processing payments, fraud protection, credit reduced risk, and perhaps other relevant financial services when you give payment data, such as when you make a purchase.",
	section5_content1_4: "Affiliates- For instance, when we share similar computer networks and where access is required to deliver our services and run our business, we allow the sharing of Personal Information among our affiliates, subsidiaries, and associated businesses.",
	section5_content1_5: "Legal- When we feel it's essential to do so in order to abide by the law or react to legitimate legal process, including that from law enforcement and perhaps other government entities, we will collect, disclose, and store Personally Identifiable information.",
	section5_content1_6: "Security and Safety- We will disclose data if:",
